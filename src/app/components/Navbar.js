...
const Navbar = () => {
    return (
        <div className=' '>
            <NavbarTop></NavbarTop>
            <div className='flex justify-between items-center border-y-[1px] lg:px-24 md:px-16 sm:px-10 px-5 border-gray-300'>
                <ul className='flex text-[16px] text-gray-900 gap-5  py-3 w-full'>
